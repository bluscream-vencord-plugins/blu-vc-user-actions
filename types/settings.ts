...
export const defaultSettings = definePluginSettings({
    ...
    kickCommand: { type: OptionType.STRING, description: "Kick Command Template", default: "!v kick {user_id}", restartNeeded: false },
    banCommand: { type: OptionType.STRING, description: "Ban Command Template", default: "!v ban {user_id}", restartNeeded: false },
    unbanCommand: { type: OptionType.STRING, description: "Unban Command Template", default: "!v unban {user_id}", restartNeeded: false },
    permitCommand: { type: OptionType.STRING, description: "Permit Command Template", default: "!v permit {user_id}", restartNeeded: false },
    unpermitCommand: { type: OptionType.STRING, description: "Unpermit Command Template", default: "!v unpermit {user_id}", restartNeeded: false },
